! function (t) {
  ...
  100: function (t, e, r) {
    ...
    }(n).default)).getMarketData(function (t, e) {
      if (t) return void chrome.browserAction.setTitle({
        title: "yStock 找不到大盤資料"
      });
      var r = "",
        n = e.tseRst,
        o = e.otcRst;
      r = n.name + " " + n.final + " " + n.upDown + " " + n.upDownVol + " " + n.volume, r += "\r\n", r += o.name + " " + o.final + " " + o.upDown + " " + o.upDownVol + " " + o.volume, console.log(r), console.log(n.final), chrome.browserAction.setTitle({
        title: r
      })
    })
  }, 51: function (t, e, r) {
    ...
    var n = r(96),
      ...
      i = {
        onSuccess: function (t) {}, onError: function (t, e) {}, _httpCall: function (t, e, r) {
          var n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : {},
            i = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : null,
            s = this;
          return s.req = (0, o.default)(t, e), r && s.req.send(r), i && s.req.redirects(i), n.hasOwnProperty("headers") && s.req.set(n.headers), this
        }, end: function (t) {
          this.req.end(function (e, r) {
            e && console.log("http error"), t(e, r)
          })
        }, get: function (t) {
          var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null;
          return this._httpCall("GET", t, {}, e, r)
        }, post: function (t, e) {
          var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
            n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : null;
          return this._httpCall("POST", t, e, r, n)
        }, put: function (t, e) {
          var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
            n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : null;
          return this._httpCall("PUT", t, e, r, n)
        }, del: function (t) {
          var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null;
          return this._httpCall("DELETE", t, e, r)
        }
      };
    e.default = i
  }, 52: function (t, e, r) {
    ...
    var o = function () {
      ...
      a = function () {
        ...
        return o(t, [{
          ...
          value: function (t) {
            var e = this;
            this.url = "https://tw.stock.yahoo.com/q/q?s=" + this.stockId, s.default.get(this.url, {}).end(function (r, n) {
              if (console.log("http end " + e.stockId, r), r) return console.log("request error: " + e.url), void t(r, o);
              var o = e._parserStock(n.text);
              t(r, o)
            })
          }
        }, {
          ...
          value: function (t) {
            var e = this;
            this.url = "https://tw.stock.yahoo.com/", s.default.get(this.url, {}).end(function (r, n) {
              if (console.log(r), r) return console.log("request error: " + e.url), void t(r, o);
              var o = e._parserMarket(n.text);
              t(r, o)
            })
          }
        }, {
          ...
          value: function (t) {
            var e = new DOMParser,
              ...
              n = null;
            null !== (n = r.querySelectorAll("table>tbody>tr>td>table")[2]) && void 0 !== n || (n = r.querySelectorAll("table>tbody>tr>td>table")[0]);
            var o = n.querySelectorAll("tr>td"),
              i = {
                id: this.stockId,
                name: "此股票不存在",
                final: "0",
            ...
            if (-1 == o[0].textContent.indexOf("加到投資組合")) return i;
            var s = o[0].textContent.replace("加到投資組合", "").replace(this.stockId, "");
            return i = {
              id: this.stockId,
              name: s,
              final: o[2].textContent,
              upDown: o[5].textContent,
              yestorday: o[7].textContent,
              max: o[9].textContent,
              min: o[10].textContent,
              time: o[1].textContent
            }
          }
        }, {
          key: "_parserMarket",
          value: function (t) {
            var e = new DOMParser,
              r = e.parseFromString(t, "text/html"),
              n = r.querySelectorAll("div.tbd0 table"),
              o = n[0],
              i = n[1],
              s = o.querySelectorAll("tr td"),
              a = {
                name: "上市",
                final: s[0].textContent,
                upDown: s[1].textContent,
                upDownVol: s[2].textContent,
                volume: s[3].textContent
              },
              u = i.querySelectorAll("tr td");
            return {
              tseRst: a,
              otcRst: {
                name: "上櫃",
                final: u[0].textContent,
                upDown: u[1].textContent,
                upDownVol: u[2].textContent,
                volume: u[3].textContent
              }
            }
          }
        }]), t
    ...
    function a(t) {
      for (var e, r, n, o, i = t.split(/\r?\n/), s = {}, a = 0, u = i.length; a < u; ++a) r = i[a], -1 !== (e = r.indexOf(":")) && (n = r.slice(0, e).toLowerCase(), o = b(r.slice(e + 1)), s[n] = o);
      return s
    }
    ...
    v.serializeObject = o, v.parseString = s, v.types = {
      html: "text/html",
    ...
    }, m(h.prototype), h.prototype._parseBody = function (t) {
    ...
    }, v.Response = h, f(l.prototype), d(l.prototype), l.prototype.type = function (t) {
      ...
      if (this._withCredentials && (e.withCredentials = !0), !this._formData && "GET" != this.method && "HEAD" != this.method && "string" != typeof r && !this._isHost(r)) {
        ...
        !i && u(o) && (i = v.serialize["application/json"]), i && (r = i(r))
      }
    ...
    }), _.prototype.del = _.prototype.delete, v.get = function (t, e, r) {
      var n = v("GET", t);
      ...
      var n = v("OPTIONS", t);
      return "function" == typeof e && (r = e, e = null), e && n.send(e), r && n.end(r), n
    }, v.del = c, v.delete = c, v.patch = function (t, e, r) {
      var n = v("PATCH", t);
      return "function" == typeof e && (r = e, e = null), e && n.send(e), r && n.end(r), n
